...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        N = X.shape[0]
        out, cache0 = affine_relu_forward(X.reshape((N, -1)), self.params['W1'], self.params['b1'])
        scores, cache1 = affine_forward(out, self.params['W2'], self.params['b2'])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout, grads['W2'], grads['b2'] = affine_backward(dout, cache1)
        _, grads['W1'], grads['b1'] = affine_relu_backward(dout, cache0)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        loss, dout = softmax_loss(scores, y)
        dout, grads['W'+suffix], grads['b'+suffix] = affine_backward(dout, cache['last']) 
